...
final class EloquentRecepcionLoteRepository implements RecepcionLoteRepositoryInterface
{
    ...
    public function guardar(RecepcionLote $lote): void
    {
        ...
        RecepcionLoteEloquentModel::updateOrCreate(
            ...
            [
                ...
                'iniciado_por' => $lote->iniciadoPor(),
                'iniciado_en' => $lote->iniciadoEn()?->format('Y-m-d H:i:s'),
                'suspendido_por' => $lote->suspendidoPor(),
                'reanudado_por' => $lote->reanudadoPor(),
                'reanudado_en' => $lote->reanudadoEn()?->format('Y-m-d H:i:s'),
    ...
    private function reconstituir(RecepcionLoteEloquentModel $model): RecepcionLote
    {
        ...
        return RecepcionLote::reconstituir(
            ...
            iniciadoPor: $model->iniciado_por,
            iniciadoEn: $model->iniciado_en?->toDateTimeImmutable(),
            suspendidoPor: $model->suspendido_por,
            reanudadoPor: $model->reanudado_por,
            reanudadoEn: $model->reanudado_en?->toDateTimeImmutable(),
